...
class TestMCPTools:
    ...
    async def test_search_code_tool(self, test_engine, test_code_dir):
        ...
        await index_repository(directories=[str(test_code_dir)], force_reindex=False)
...
class TestErrorHandling:
    ...
    async def test_search_without_index(self, test_engine):
        ...
        result = await search_code(query="test query", limit=10, min_relevance=0.0)
    ...
    async def test_list_nonexistent_directory(self):
        ...
        result = await list_directory(directory_path="/this/directory/does/not/exist")
